...
"
OPTS="${JAVA_FLAGS} -Xmx12G -Xms4G -server -XX:+UseCompressedOops -XX:+UseParNewGC -cp .:${LIB_DIR}:${CONFIG_DIR}:${LIB_DIR_JARS} com.yidian.push.instant.services.Service ${CONFIG_DIR}/prod_config.json"
KILLPROC_OPTS=""
