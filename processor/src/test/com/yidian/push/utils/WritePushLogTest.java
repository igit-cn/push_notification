...
public class WritePushLogTest {
    ...
    public void testWriteLog() throws Exception {
        ...
        hostPort.setPort(8888);
        List<PushLog.LogItem> logItemList = Arrays.asList(
                new PushLog.LogItem(DateTime.now().getMillis(), 1L, "0A7oktXa", null, 2),
                new PushLog.LogItem(DateTime.now().getMillis(), 1L, "0A7zLB6i", "u676", 8),
                new PushLog.LogItem(DateTime.now().getMillis(), 1L, "l_0123125c0c5305fd264700060035", null, 64)
        );
